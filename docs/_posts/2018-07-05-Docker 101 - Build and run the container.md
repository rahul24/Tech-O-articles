...
### Summary
This post explains, how to build an image using the docker file. Learn about the commands, use with docker file and put together all and create a custom image. Learn about running the image and states of container.
